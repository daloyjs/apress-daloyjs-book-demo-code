...
/**
 * Chapter 8: catalog/orders + browser perimeter (cors + csrf).
 * Auth arrives in Chapter 10; until then create routes are open for contract labs.
 */
export function buildApp(
  ...
  const app = new App({
    ...
    openapi: { info: { title: "orders-api", version: "0.8.0" } },
    docs: true,
    ...appOpts,
  });
